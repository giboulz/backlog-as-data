---
name: sdd-impl-medium
description: Implémenteur SDD (spec→tests→code→vérif→commit) au palier de reasoning « medium ». Généré ; invoqué par /sdd-run-ticket via subagent_type.
